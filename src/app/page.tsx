  ...
  return (
    <div className="min-h-screen bg-white">
              ...
              <Sheet open={isMobileMenuOpen} onOpenChange={setIsMobileMenuOpen}>
                ...
                <SheetContent side="left" className="bg-white">
                  ...
                  <div className="flex flex-col gap-4 p-4">
                    ...
                    <a href="https://wa.me/56940156689?text=Hola%20MAFA%20%F0%9F%91%8B%20Me%20interesa%20conocer%20m%C3%A1s%20sobre%20Impulso%20Digital.%20%C2%BFCu%C3%A1les%20son%20los%20pr%C3%B3ximos%20pasos%3F" onClick={() => setIsMobileMenuOpen(false)} target="_blank" rel="noopener noreferrer" className="bg-green-500 hover:bg-green-600 text-white mt-4 px-4 py-2 rounded-lg hover:shadow-lg transition font-bold text-sm md:text-base">Contactar</a>
                  </div>
                </SheetContent>
              </Sheet>
            </div>
      ...
      <section id="process" className="py-16 md:py-24 bg-gray-50">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl md:text-4xl font-bold text-center mb-12">Proceso en 3 Pasos</h2>
