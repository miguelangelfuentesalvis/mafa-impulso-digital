          ...
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                ...
                <li><a href="#process" className="hover:text-white transition">Proceso</a></li>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                <li><a href="mailto:mafagrowthdigital@gmail.com" className="hover:text-white transition flex items-center gap-2"><Mail className="w-4 h-4" /> Email</a></li>
                <li><a href="https://wa.me/56940156689?text=Hola%20MAFA%20%F0%9F%91%8B%20Me%20interesa%20conocer%20m%C3%A1s%20sobre%20Impulso%20Digital.%20%C2%BFCu%C3%A1les%20son%20los%20pr%C3%B3ximos%20pasos%3F" target="_blank" rel="noopener noreferrer" className="hover:text-white transition flex items-center gap-2"><MessageCircle className="w-4 h-4" /> WhatsApp</a></li>
                <li><a href="https://mafagrowthdigital.com/" target="_blank" rel="noopener noreferrer" className="hover:text-white transition flex items-center gap-2"><Globe className="w-4 h-4" /> Web</a></li>
              </ul>
            </div>
            <div>
